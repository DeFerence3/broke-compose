...
class RestoreDatabaseUseCase @Inject constructor(
    ...
    operator fun invoke(activity: ComponentActivity): Flow<Boolean> = callbackFlow {
            ...
            .apply {
                onCompleteListener { success, message, exitCode ->
                    ...
                    launch {
                        ...
                        // Restart only after the suspend function completes
        ...
        awaitClose() // keeps the flow alive until closed
